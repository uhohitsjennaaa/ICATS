//Driver file for program, includes sdl inner workings and reads keypresses.
...
int main(){
	...
	while(!quit){
		...
		//Draw player2
		renderTexture(player1,ren,p1_x,p1_y,P_WIDTH,P_HEIGHT);
		renderTexture(player2,ren,p2_x,p2_y,P_WIDTH,P_HEIGHT);
